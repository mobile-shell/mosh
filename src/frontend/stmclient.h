...
public:
  STMClient( const char *s_ip, const char *s_port, const char *s_key, const char *predict_mode, unsigned int s_verbose, const char *predict_overwrite, ChWidthPtr chwidths )
    ...
    escape_requires_lf( false ), escape_key_help( L"?" ),
      ...
      local_framebuffer( 1, 1, chwidths ),
      new_state( 1, 1, chwidths ),
      overlays(),
      network(),
